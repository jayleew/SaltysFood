...
{
    public class CookedPottedCheeseSauce : CustomItem
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "CookedPottedCheeseSauce";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted Cheese Sauce").AssignMaterialsByNames();
        ...
        public override Item SplitSubItem => (Item)GDOUtils.GetCustomGameDataObject<CheeseSauce>().GameDataObject;
