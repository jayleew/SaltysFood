...
namespace SaltyFood.Customs.Items
{
    public class CheeseSauce : CustomItem
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Cheese Sauce").AssignMaterialsByNames();
