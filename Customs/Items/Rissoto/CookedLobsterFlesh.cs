...
namespace SaltyFood.Customs.Items
{
    public class CookedLobsterFlesh : CustomItem
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("CookedLobsterFlesh").AssignMaterialsByNames();
