...
namespace SaltyFood.Customs.Items
{
    public class CookedPottedRissoto : CustomItem
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Cooked Potted Rissoto").AssignMaterialsByNames();
        ...
        public override Item SplitSubItem => (Item)GDOUtils.GetCustomGameDataObject<CookedRissoto>().GameDataObject;
