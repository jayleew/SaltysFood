...
namespace SaltyFood.Customs.Dishes
{
    public class NachosDish : CustomDish
    {
        ...
        {
            { Locale.English, "Make chips: Add oil to a pot with a tortilla. Chop cooked tortilla." }
        };
