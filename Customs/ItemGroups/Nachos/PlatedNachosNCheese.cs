...
{
    public class PlatedNachosNCheese : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PlatedNachosNCheese";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Plated NachosNCheese").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<CheeseSauce>().GameDataObject
                },
                Min = 1,
                Max = 1
            }
