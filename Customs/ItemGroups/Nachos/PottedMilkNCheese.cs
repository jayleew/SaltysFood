...
{
    public class PottedMilkNCheese : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedMilkNCheese";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted MilkNCheese").AssignMaterialsByNames();
        ...
        public override List<Item.ItemProcess> Processes => new List<Item.ItemProcess>
        {
            new Item.ItemProcess
            {
                ...
                Duration = 3,
                Result = (Item)GDOUtils.GetCustomGameDataObject<CookedPottedCheeseSauce>().GameDataObject
            }
        };
