...
{
    public class PottedRiceNBroth : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedRiceNBroth";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted Rice").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetExistingGDO(ItemReferences.BrothCookedOnion)
                },
        ...
        public override List<Item.ItemProcess> Processes => new List<Item.ItemProcess>
        {
            new Item.ItemProcess
            {
                ...
                Duration = 5,
                Result = (Item)GDOUtils.GetCustomGameDataObject<CookedPottedRiceNBroth>().GameDataObject
            }
        };
