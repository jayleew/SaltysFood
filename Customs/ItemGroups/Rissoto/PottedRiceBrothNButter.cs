...
{
    public class PottedRiceBrothNButter : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedRiceBrothNButter";
        public override string ColourBlindTag { get => "RicBroBut"; protected set => base.ColourBlindTag = value; }
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted RiceBrothNButter").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<CookedPottedRiceNBroth>().GameDataObject
                },
