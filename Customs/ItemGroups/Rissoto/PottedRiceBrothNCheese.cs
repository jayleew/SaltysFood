...
{
    public class PottedRiceBrothNCheese : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedRiceBrothNCheese";
        public override string ColourBlindTag { get => "RicBroChe"; protected set => base.ColourBlindTag = value; }
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted RiceBrothNCheese").AssignMaterialsByNames();
