...
{
    public class PlatedLobsterRissoto : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PlatedLobsterRissoto";
        public override string ColourBlindTag  { get => "RisLob"; protected set => base.ColourBlindTag = value; }
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Plated LobsterRissoto").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<PlatedRissoto>().GameDataObject
                },
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<CookedLobsterFlesh>().GameDataObject
                },
                Min = 1,
                Max = 1
            }
