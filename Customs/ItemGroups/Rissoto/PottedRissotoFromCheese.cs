...
{
    public class PottedRissotoFromCheese : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedRisotoFromCheese";
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<PottedRiceBrothNButter>().GameDataObject
                },
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetExistingGDO(ItemReferences.CheeseGrated)
                },
                Min = 1,
                Max = 1
            }
