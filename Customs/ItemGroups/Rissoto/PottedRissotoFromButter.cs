...
{
    public class PottedRissotoFromButter : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedRisotoFromButter";
        public override string ColourBlindTag { get => "RawRis"; protected set => base.ColourBlindTag = value; }
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted Rissoto").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<PottedRiceBrothNCheese>().GameDataObject
                },
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<IngredientLib.Ingredient.Items.Butter>().GameDataObject
                },
                Min = 1,
                Max = 1
            }
        ...
        public override List<Item.ItemProcess> Processes => new List<Item.ItemProcess>
        {
            new Item.ItemProcess
            {
                ...
                Duration = 5,
                Result = (Item)GDOUtils.GetCustomGameDataObject<CookedPottedRissoto>().GameDataObject
            }
        };
        ...
        public override void OnRegister(ItemGroup gameDataObject)
        {
            ...
            //        GameObject = GameObjectUtils.GetChildObject(gameDataObject.Prefab, "Pot_1"),
            //        DrawAll = true
            //    },
            //    new ItemGroupView.ComponentGroup
            //    {
            //        Item = (Item)GDOUtils.GetExistingGDO(ItemReferences.BrothCookedOnion),
            //        GameObject = GameObjectUtils.GetChildObject(gameDataObject.Prefab, "Broth"),
            //        DrawAll = true
            //    },
            //    new ItemGroupView.ComponentGroup
            //    {
            //        Item = (Item)GDOUtils.GetCustomGameDataObject<RawLobster>().GameDataObject,
            //        GameObject = GameObjectUtils.GetChildObject(gameDataObject.Prefab, "Rice_Bowl"),
            //        DrawAll = true
            //    }
            //};
        }
